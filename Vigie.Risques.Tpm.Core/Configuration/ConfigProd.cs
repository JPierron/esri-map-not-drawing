...
{
    public class ConfigProd : IConfig
    {
        public string ApplicationName => "Vigie.Risques.Tpm";

        public string AppCenterAndroidAppId => "";

        public string AppCenterIosAppId => "";

        public string MapLayerEvenementsPoint => "https://services6.arcgis.com/5mEtJyK0dGzH3gtk/arcgis/rest/services/PUB_Evenement/FeatureServer/0";
        public string MapLayerEvenementsLine => "https://services6.arcgis.com/5mEtJyK0dGzH3gtk/arcgis/rest/services/PUB_Evenement/FeatureServer/1";
        ...
        public string ApiBaseUrl => "https://vigie-risques.azurewebsites.net/api/";
